...
"[project]/Desktop/03.MENSANA/mensana-next/app/admin/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminPage() {
    ...
    const now = new Date();
    const [dia, setDia] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(now.getDate());
    ...
    const [totalDia, setTotalDia] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [totalMes, setTotalMes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [diasConIngresos, setDiasConIngresos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$src$2f$services$2f$database$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseService"].query('reservas', {
                select: 'precio_total',
                filters: [
                    {
                ...
                "AdminPage.useEffect": (result)=>{
                    if (result.success) {
                        const total = result.data.filter({
                            "AdminPage.useEffect.total": (r)=>r.precio_total && parseFloat(r.precio_total) > 0
                        }["AdminPage.useEffect.total"]).reduce({
                            "AdminPage.useEffect.total": (sum, r)=>sum + parseFloat(r.precio_total)
                        }["AdminPage.useEffect.total"], 0);
                        setTotalDia(total);
                    }
                }
            }["AdminPage.useEffect"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$src$2f$services$2f$database$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DatabaseService"].query('reservas', {
                ...
                "AdminPage.useEffect": (result)=>{
                    if (result.success) {
                        const conMonto = result.data.filter({
                            "AdminPage.useEffect.conMonto": (r)=>r.precio_total && parseFloat(r.precio_total) > 0
                        }["AdminPage.useEffect.conMonto"]);
                        setTotalMes(conMonto.reduce({
                            "AdminPage.useEffect": (sum, r)=>sum + parseFloat(r.precio_total)
                        }["AdminPage.useEffect"], 0));
                        const dias = conMonto.map({
                            "AdminPage.useEffect.dias": (r)=>parseInt(r.fecha.split('-')[2], 10)
                        }["AdminPage.useEffect.dias"]);
                        setDiasConIngresos([
                            ...new Set(dias)
                        ]);
                    }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        ].map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                href: item.href,
...
_s(AdminPage, "TliH3SpSVrNgpNHrHXRcNYvQ5+Q=", false, function() {
    return [
...
"[project]/Desktop/03.MENSANA/mensana-next/node_modules/lucide-react/dist/esm/icons/trending-up.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TrendingUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("trending-up", __iconNode);
;
 //# sourceMappingURL=trending-up.js.map
}),
"[project]/Desktop/03.MENSANA/mensana-next/node_modules/lucide-react/dist/esm/icons/trending-up.js [app-client] (ecmascript) <export default as TrendingUp>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "TrendingUp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$03$2e$MENSANA$2f$mensana$2d$next$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
//# sourceMappingURL=Desktop_03_MENSANA_mensana-next_9cd92e9d._.js.map